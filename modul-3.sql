...
SELECT 1 = true AS hasil_1;

--- lakukan perbandingan 1 = false
SELECT 1 = false AS hasil_2;

--- lakukan perbandingan 5 >= 5
SELECT 5 >= 5 AS hasil_3;

--- lakukan perbandingan 5.2 = 5.20000
SELECT 5.2 = 5.20000 AS hasil_4;

--- lakukan perbandingan NULL = 1
SELECT NULL = 1 AS hasil_5;

--- lakukan perbandingan NULL = NULL
SELECT NULL = NULL AS hasil_6;
